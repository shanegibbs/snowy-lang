...
DeclareVar *DeclareVar::clone() const { return new DeclareVar(*this); }

const TypePtr DeclareVar::getType() const { return expr->getType(); }

const string &DeclareVar::getName() const { return *ident->getName(); }

const Ident &DeclareVar::getIdent() const { return *ident; }

const Expression &DeclareVar::getExpression() const { return *expr; }
