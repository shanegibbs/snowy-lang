...
./configure CXXFLAGS='-v -Wno-deprecated-register -Wl,--rpath=/home/travis/snowy-deps/lib64 -Wl,--rpath=/home/travis/snowy-deps/lib -I/home/travis/snowy-deps/include -L/home/travis/snowy-deps/lib' --enable-debug
make
make check
